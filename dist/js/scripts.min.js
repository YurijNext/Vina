...
$(document).ready(function () {
  ...
  var viewFullList = function viewFullList() {
    var openBtn = $('.b-cats__all'),
        closeBtn = $('.js-close-full'),
        searchBlock = $('.b-search__wrap');
    openBtn.on('click', function (e) {
      var parent = $(this).parents('.b-cats__group');
      e.preventDefault();
    ...
    closeBtn.on('click', function (e) {
      var sibling = $(this).siblings('.b-cats__full');
      e.preventDefault();
  ...
  var viewList = function () {
    var openBtn = $('.b-aside__drop-btn'),
        closeBtn = $('.js-close-full-list');
    openBtn.on('click', function (e) {
      e.preventDefault();
      var thisBlock = $(this).parents('.b-aside__drop').siblings('.js-full-list');
      thisBlock.addClass('full-list__active');
    });
    closeBtn.on('click', function (e) {
      e.preventDefault();
      var thisBlock = $(this).parents('.js-full-list');
  ...
  var search = function () {
    var clearSearch = $('.js-field-erase'),
  ...
  var filtersAccorderon = function () {
    var btn = $('.js-open-list'),
        drop = $('.b-aside__drop');
    btn.on('click', function () {
      var thisDropList = $(this).siblings('.b-aside__drop');
  ...
  var dropdown = function () {
    var openBtn = $('.js-open-drop'),
        dropdown = $('.b-main__dropdown'),
        item = $('.b-main__dropdown-title'),
        input = $('.b-main__input');
    openBtn.on('click', function () {
      var sibling = $(this).siblings('.b-main__dropdown');
  ...
  var lookingSlider = new Swiper('.js-looking-slider', {
    loop: true,
    slidesPerView: 4,
    pagination: {
